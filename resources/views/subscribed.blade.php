...
@section('content')
            <!-- =======HERo======== -->
            <main class="flex flex-col items-center justify-center flex-grow bn-para">
                <h1
                    class="text-6xl text-[#FFC400] font-bold bg-gradient-to-bl from-[#FFC400] to-[#E8B200] bg-clip-text text-transparent lg:text-[90px] 2xl:text-[124px] xl:font-normal">
                    Subscribed
                </h1>
                <p
                    class="text-xl text-[#FFC400] text-center mt-4 lg:text-[28px] lg:w-1/3 lg:leading-[36px] 2xl:w-1/4 2xl:text-[35px] 2xl:leading-[52px]">
                    You are successfully subscribed to the Inspiration Daily Messages
                </p>
                <a href="{{ route('welcome') }}">
                <button
                    class="jost font-semibold mt-8 bg-[#FFC400] text-white py-3 px-6 rounded-lg flex items-center inter cursor-pointer 2xl:text-[18px]">
                    Back To Home
                    ...
                    <svg width="116" height="116" viewBox="0 0 176 176" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                            <filter id="filter0_d_8007_1887" x="0.17366" y="0.938599" width="175.014" height="175.014"
                                ...
                                <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_8007_1887"
                                    result="shape" />
                            </filter>
