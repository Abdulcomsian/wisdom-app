...
@section('content')
    ...
    <div class="banner flex flex-col mt-[120px] items-center justify-center text-center">
        <div class="bn-headings">
            ...
            <h2
                class="text-2xl md:text-5xl font-[800] text-[#3A3A3A] mt-1 md:mt-2 2xl:text-[88px] 2xl:font-extrabold">
                From Yours Truly
            </h2>
        </div>
        <div class="image">
    ...
    <div class="background-icons hidden lg:block">
        <!-- 1 -->
        <div class="icon1">
            <svg width="116" height="116" viewBox="0 0 176 176" fill="none"
    ...
    <div class="bg-[linear-gradient(45deg,#FFC400,#E8B200)] py-[40px] md:px-[80px]">
        <div class="container mx-auto p-4 text-center">
            ...
            <div class="flex flex-col md:flex-row justify-center gap-[20px] my-8 2xl:gap-[30px]">
                ...
                <div
                    ...
                    <h2 class="sf-pro-regular text-4xl font-bold text-[#3A3A3A] italic xl:leading-[71px] 2xl:text-[60px]">
                        $1.99
                    </h2>
                    <p
                        class="sf-pro-regular text-sm text-[#3A3A3A] xl:leading-[23px] italic 2xl:text-[20px] 2xl:mt-6 font-semibold">
                        One text a week<br />Can select up to 2 categories.
                    </p>
                    <button class="bg-[#FFC400] text-[#3A3A3A] font-semibold italic py-2 px-4 rounded mt-4 w-full 2xl:mt-6">
                        Select
                    </button>
                </div>
                ...
                <div
                    class="sf-pro-regular bg-white rounded-lg p-6 shadow-md mb-4 md:mb-0 md:w-1/4 md:text-left chk-para 2xl:p-12 2xl:w-[410px] 2xl:h-[281px]">
                    <h2 class="text-4xl font-bold text-[#3A3A3A] italic xl:leading-[71px] 2xl:text-[60px]">
                        $4.99
                    </h2>
                    <p class="text-sm text-[#3A3A3A] italic xl:leading-[23px] 2xl:text-[20px] 2xl:mt-6 font-semibold">
        ...
        <form class="max-w-sm w-[85%] md:w-full mx-6 md:mx-auto mt-[41px] sf-pro-regular font-normal">
            <div class="mb-4">
                <label for="email" class="block text-lg font-medium mb-1"><a href="#">Email Address</a></label>
            ...
            <div class="mb-4">
                <label for="email" class="block text-lg font-medium mb-1"><a href="#">Phone Number</a></label>
