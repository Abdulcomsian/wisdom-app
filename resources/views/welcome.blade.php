...
@section('header')
    ...
    @if (!auth()->user()) {
        <form id="registrationForm" action="{{ route('register') }}" method="post">
            ...
            <!-- Hidden field for selected plan ID -->
            <div class="bg-[linear-gradient(45deg,#FFC400,#E8B200)] py-[40px] md:px-[80px]">
                    ...
                    <div class="flex flex-col md:flex-row justify-center gap-[20px] my-8 2xl:gap-[30px]">
                        @foreach ($plans as $plan)
                            <div
                                ...
                                <h2
                                    class="sf-pro-regular text-4xl font-bold text-[#3A3A3A] xl:leading-[71px] 2xl:text-[60px]">
                            ...
                            @foreach ($categories as $category)
                                <label class="flex items-center space-x-2">
                                    <input type="checkbox" name="categories[]" value="{{ $category->id }}"
                                        class="form-checkbox  form-checkbox-custom h-5 w-5 text-gray-800 category-checkbox"
                                        disabled>
                                    <span
                                        class="text-md font-medium 2xl:text-[25px] mb-1 pt-1">{{ $category->name }}</span>
                                </label>
                            @endforeach
                        </div>
                    </div>
                ...
                <div class="max-w-2xl w-[90%] md:w-full mx-6 md:mx-auto mt-[41px] sf-pro-regular font-normal">
                    <div class="flex flex-col md:flex-row md:space-x-4 mb-4">
                        <div class="w-full md:w-1/2">
                            ...
                            <input type="text" name="first_name" id="firstName" placeholder="John"
                                class="w-full px-4 py-[10px] text-[#00000] rounded-lg focus:ring-2 focus:ring-[#8B89D9]"
                                required>
                        </div>
                        <div class="w-full md:w-1/2">
                        ...
                        {{-- <div class="w-full md:w-1/2">
                                ...
                                <div class="flex items-center space-x-2">
                                    <div class="flex items-center border border-gray-300 rounded-lg overflow-hidden">
                                        ...
                                        <select id="countryCode" name="country_code" class="bg-white py-2 text-sm border-r text-[#00000]"></select>
                                    </div>
                                    <input id="phone" name="phone_no" type="text" placeholder="1234567890"
                                        class="flex-1 px-3 py-2 text-[#00000] bg-white text-sm rounded-lg focus:ring-2 focus:ring-[#8B89D9]">
                                </div>
                            </div> --}}
                                    ...
                                    <div class="flex items-center bg-white px-3 py-2">
                                        <div class="mr-2">
                                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                                ...
                                                <path
                                                    d="M9 2.76013H15.48C14.97 2.25013 14.4 1.77013 13.8 1.38013H9V2.76013Z"
                                                    fill="white" />
                                                <path
                                                    d="M9 4.14001H16.59C16.26 3.63001 15.9 3.18001 15.51 2.76001H9V4.14001Z"
                                                    fill="#ED4C5C" />
                                                <path
                                                    d="M9 5.52014H17.31C17.1 5.04014 16.86 4.56014 16.59 4.14014H9V5.52014Z"
                                                    fill="white" />
                                                <path
                                                    d="M9 6.90002H17.76C17.64 6.42002 17.49 5.97002 17.31 5.52002H9V6.90002Z"
                                                    fill="#ED4C5C" />
                                                <path
                                                    d="M9 8.30993H17.97C17.94 7.82993 17.85 7.37993 17.76 6.92993H9V8.30993Z"
                                                    fill="white" />
                                                <path
                                        ...
                                        <span class="text-[#434343] text-sm"> +1 </span>
                    ...
                    <div>
                        ...
                        <!--Password  -->
                        <!-- <div class="mb-4 relative sf-pro-regular">
                                    <label for="password" class="block text-[#3A3A3A] mb-1">Password</label>
                                    <input type="password" id="password" placeholder="Password"
                                        class="w-full px-4 py-2 border border-[#3A3A3A] rounded-md placeholder-[#3A3A3A] focus:outline-none focus:ring-2 focus:ring-yellow-500" />
        
                                    <svg class="fas fa-eye absolute top-2/3 right-3 transform -translate-y-1/2 cursor-pointer text-[#3A3A3A]"
                    ...
                    <div class="flex gap-[100px] mb-4 md:mb-0">
                        ...
                        <div>
                            ...
                            <ul class="mb-1 md:space-y-2">
                                <li>
                                    <a class="text-[#3A3A3A] Open-sans  2xl:text-[20.44px] text-[14px] md:text-[16px]"
                                        href="{{ asset('asset/pdf/PRIVACY POLICY for YT.pdf') }}" target="_blank">Terms Of
                                        Use</a>
                                </li>
                                <li>
                                    <a class="text-[#3A3A3A] Open-sans 2xl:text-[20.44px] text-[14px] md:text-[16px]"
                                        href="{{ asset('asset/pdf/TERMS OF USE for YT.pdf') }}" target="_blank">Privacy
                                        Policy</a>
                                </li>
                                <!-- <li>
                                        <a class="text-[#3A3A3A] Open-sans 2xl:text-[20.44px] text-[14px] md:text-[16px]"
                    ...
                    $.ajax({
                        ...
                        error: function(xhr) {
                            ...
                            if (xhr.status === 422) {
                                ...
                                'Validation Error'); // Show errors in Toastr
                            } else {
